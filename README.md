...
```javascript
// En tu frontend, necesitas:
// 1. Cargar Culqi Widget/SDK
// 2. Generar un TOKEN

const pago = {
  pedido_id: pedidoCreado.id,
  monto: pedidoCreado.total,
  token: tokenDeCulqi, // Generado por Culqi en el frontend
...
- Los datos de clientes se guardan automaticamente (sin register)
- Stock se descuenta automáticamente al crear pedido
- Moneda por defecto: PEN (Soles peruanos)
- Monto en Culqi se envía en céntimos
